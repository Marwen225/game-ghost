...
from enemies import Ghost, FlyingGhost
		...
		for y, row in enumerate(data):
			for x, tile in enumerate(row):
				if tile >= 0:
					...
					if tile == 57:
						# Fantôme volant (utilisons la tuile 57 - ancien diamant)
						flying_enemy = FlyingGhost(x*TILE_SIZE, y*TILE_SIZE, win)
						self.objects_group[3].add(flying_enemy)
